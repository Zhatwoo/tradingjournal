...
export default function CoachAi({ kpis, filtered, peso }) {
  ...
  const generateAIResponse = (question, userMetrics) => {
    ...
    // Default response - More specific
    return `🤖 **Coach AL**\n\nI'm here to help you improve your trading! Based on your data, I can provide advice on:\n\n📊 **Performance Analysis:**\n• Win rate optimization\n• Profit factor improvement\n• Risk management\n• Strategy development\n• Drawdown analysis\n• Session performance\n\n🧠 **Trading Psychology:**\n• Confidence building\n• Emotional control\n• Mental discipline\n• Stress management\n• Consecutive loss recovery\n\n💡 **Ask me specific questions like:**\n• "How can I improve my win rate?"\n• "What's my best strategy?"\n• "How should I manage risk?"\n• "I'm losing confidence, help!"\n• "What's causing my drawdowns?"\n• "When should I trade?"\n\nI analyze your actual trading data to give you personalized, specific advice!`;
  };
